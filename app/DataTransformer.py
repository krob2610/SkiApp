...
class DataTransformer:
    ...
    # TODO iterate over folders and seek for csv to apply changes
    ...
    # TODO: need adjustment for example if the value is missing in the beginign it will put nan - Maybe not needed anyway
